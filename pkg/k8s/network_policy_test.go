...
func (s *K8sSuite) TestParseNetworkPolicy(c *C) {
	...
	ctx := policy.SearchContext{
		From: labels.LabelArray{
			labels.NewLabel(k8sTypes.PodNamespaceLabel, v1.NamespaceDefault, k8sTypes.LabelSource),
...
func (s *K8sSuite) TestNetworkPolicyExamples(c *C) {
  ...
  "spec": {
	...
	ctx := policy.SearchContext{
		From: labels.LabelArray{
			labels.NewLabel(k8sTypes.PodNamespaceLabel, "myns", k8sTypes.LabelSource),
  ...
  "spec": {
	...
	ctx = policy.SearchContext{
		...
		To: labels.LabelArray{
			...
			labels.NewLabel(k8sTypes.PodNamespaceLabel, "expressions", k8sTypes.LabelSource),
			// component==redis is in the policy.
