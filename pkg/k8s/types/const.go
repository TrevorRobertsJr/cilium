...
const (
	...
	PodNamespaceLabel      = "cilium.k8s.namespace"
	...
	// change this to cilium.k8s.namespace.ns-labels as the user can pick
	// a kubernetes namespace called "ns-labels", causing conflicts between
	// the namespaces' labels and the namespace name.
	PodNamespaceMetaLabels = "cilium.k8s.ns-labels"
